...
The JSON-RPC layer of the kalychain provides developers with the functionality of easily interacting with the blockchain,
...
To start the kalychain in development mode, which is explained in the [CLI Commands](/docs/get-started/cli-commands) section, 
run the following: 
````bash
