...
The blockchain interface is implemented by the [**Minimal**](../../docs/architecture/modules/minimal/) server. It is the base implementation that's passed into the JSON RPC layer.
