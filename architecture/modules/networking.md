...
On top of **libp2p**, the kalychain uses the **GRPC** protocol. <br />
...
Earlier, we mentioned that the kalychain leverages several GRPC protocols.<br />
...
The kalychain also implements several service methods that are used by other nodes on the network. <br />
