...
the kalychain stores these mentioned key files in two distinct directories - **consensus** and **keystore**.
...
:::info Key Type
All private key files generated and used inside the kalychain are relying on ECDSA with the curve [secp256k1](https://en.bitcoin.it/wiki/Secp256k1).
