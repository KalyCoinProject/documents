...
This guide goes into detail on how to set up a Proof of Stake network with the kalychain, how to stake funds for nodes
...
Setting up a cluster with the kalychain is covered in
the [Local Setup](/docs/get-started/set-up-ibft-locally)
